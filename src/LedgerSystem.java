...
public class LedgerSystem_Copy {
   ...
   private static void viewTransactionHistory() {
    ...
    List<Transaction> transactions = new ArrayList<>(); // To store fetched transactions
    ...
    try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
        ...
        while (rs.next()) {
            ...
            transactions.add(new Transaction(date, description, type, amount));
        }

        // Process transactions in reverse order to compute running balance
        ...
        exportToCSV(transactions, runningBalance);
